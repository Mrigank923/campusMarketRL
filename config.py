...
MANUAL_RESTOCK_UNIT_COST: Final[float] = 1.8
...
NET_PROFIT_REWARD_DIVISOR: Final[float] = 120.0
SATISFACTION_DELTA_REWARD_WEIGHT: Final[float] = 8.0
SATISFACTION_LEVEL_REWARD_WEIGHT: Final[float] = 4.0
INVENTORY_BALANCE_PENALTY_MULTIPLIER: Final[float] = 10.0
INVENTORY_PROGRESS_REWARD_MULTIPLIER: Final[float] = 6.0
CONTROLLABLE_STOCKOUT_PENALTY: Final[float] = 12.0
BUDGET_SHORTFALL_THRESHOLD: Final[float] = 0.2
BUDGET_SHORTFALL_PENALTY_MULTIPLIER: Final[float] = 10.0
