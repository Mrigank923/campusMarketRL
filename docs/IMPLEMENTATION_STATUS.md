...
- repo root package modules contain the reusable environment package, simulation logic, HTTP client, and Gym wrapper.
- `server/` contains the FastAPI server and the core simulation runtime.
